...
public class ConsumerThreadDemo {
    ...
    public class ConsumerRunnable implements Runnable {
        ...
        public ConsumerRunnable(String bootstrapServers,
            ...
            properties.setProperty(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, KafkaConstants.KDSERIALIZER);
            properties.setProperty(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, KafkaConstants.KDSERIALIZER);
